        ...
        <Title title={"Home"}>
                    ...
                    <Row>
                        <Col lg="6" md="6">
                            <div className="banner-content">
                                ...
                                <p>Elevate your home with handcrafted pieces designed to inspire.</p>
            ...
            <div className="carousel">
                ...
                <Carousel responsive={responsive}>
                    <div><ProductCard productImg ={demo} productName='Chair' productPrice="5.99$" productType="chair"></ProductCard></div>
                    <div><ProductCard productImg ={demo} productName='Chair' productPrice="5.99$" productType="chair"></ProductCard></div>
                    <div><ProductCard productImg ={demo} productName='Chair' productPrice="5.99$" productType="chair"></ProductCard></div>
                    <div><ProductCard productImg ={demo} productName='Chair' productPrice="5.99$" productType="chair"></ProductCard></div>
                    <div><ProductCard productImg ={demo} productName='Chair' productPrice="5.99$" productType="chair"></ProductCard></div>
